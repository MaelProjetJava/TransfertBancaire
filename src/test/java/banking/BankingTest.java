...
public class BankingTest {
	...
	public void successfulTransfer() throws Exception {
        ...
        @Test
        public void negativeAmountAfterTransfer() throws Exception {
            float before0 = myDAO.balanceForCustomer(0);
            float before1 = myDAO.balanceForCustomer(1);
            
            try {
                myDAO.bankTransferTransaction(0, 1, 110);
            } catch (SQLException e) {
                assertEquals("Account 0 modified during error !", before0, myDAO.balanceForCustomer(0), 0.001f);
                assertEquals("Account 1 modified during error !", before1, myDAO.balanceForCustomer(1), 0.001f);
                return;
            }
        ...
        @Test
        public void debiteurInexistant() throws Exception {
            float before1 = myDAO.balanceForCustomer(1);
            
            try {
                myDAO.bankTransferTransaction(21, 1, 110f);
            } catch (SQLException e) {
                assertEquals("Account 1 modified during error !", before1, myDAO.balanceForCustomer(1), 0.001f);
                return;
            }
        ...
        @Test
        public void crediteurInexistant() throws Exception {
            float before1 = myDAO.balanceForCustomer(1);
            
            try {
                myDAO.bankTransferTransaction(1, 21, 40f);
            } catch (SQLException e) {
                assertEquals("Account 1 modified during error !", before1, myDAO.balanceForCustomer(1), 0.001f);
                return;
            }
